    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        builder: (context, snap) {
          ...
          // Request notification permission on Android 13+ and reschedule
          if (!_didReschedule && snap.hasData) {
            _requestNotificationPermission();

            _didReschedule = true;
            final active = all
                .where((t) => !t.isCompleted && t.deadline.isAfter(DateTime.now()))
                .toList();
            ...
            SliverToBoxAdapter(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    Row(children: [
                      _StatPill(
                          'Active', '${active.length}', AppColors.primary),
                    ...
                    SizedBox(
                        ...
                        child: ListView(
                            ...
                            children: [
                              ...
                              'Today',
                              'Overdue',
                              ...TaskCategory.values.map((c) => c.label)
                            ]
                                .map((f) => Padding(
  ...
  void _showSortSheet(BuildContext context) {
    showCupertinoModalPopup(
        ...
        builder: (ctx) => CupertinoActionSheet(
              ...
              actions: ['Smart', 'Deadline', 'Priority']
    ...
    return GestureDetector(
        ...
        child: Container(
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                    color: task.priority.color.withOpacity(0.06),
                    blurRadius: 6,
                            ...
                            child: Column(
                              ...
                              Row(children: [
                                ...
                                if (task.isOverdue)
                                  ...
                                  _Badge('TODAY', AppColors.warning,
              ...
              if (task.subtasks.isNotEmpty)
                Padding(
                    ...
                    child: Column(children: [
                      Row(children: [
                        Text(
                            '${task.subtasks.where((s) => s.isDone).length}/${task.subtasks.length} steps',
                            style: const TextStyle(
                      ...
                      LinearPercentIndicator(
                          ...
                          progressColor: task.priority.color,
...
class _BottomBar extends StatelessWidget {
  ...
  Widget _tab(int i, IconData icon, String label) => Expanded(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Text(label,
                style: TextStyle(
                    ...
                    color: idx == i ? AppColors.primary : AppColors.textHint,
                    fontWeight:
                        idx == i ? FontWeight.w600 : FontWeight.normal)),
          ])));
}
