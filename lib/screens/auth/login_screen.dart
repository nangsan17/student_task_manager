...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _forgot() async {
    if (_emailCtrl.text.trim().isEmpty) {
      setState(() => _error = 'Enter your email first'); return;
    }
    try {
  ...
  String _friendly(String e) {
    if (e.contains('user-not-found') || e.contains('invalid-credential')) return 'Invalid email or password.';
          ...
          child: Padding(
            ...
            child: Form(key: _formKey, child: Column(
              ...
              children: [
                ...
                Text('Sign in to manage your tasks', style: Theme.of(context).textTheme.bodyMedium)
                ...
                TextFormField(
                  ...
                  validator: (v) => (v == null || v.isEmpty) ? 'Password is required'
                      : v.length < 6 ? 'Minimum 6 characters' : null,
                ).animate().fadeIn(delay: 200.ms),

                Align(alignment: Alignment.centerRight,
                  child: CupertinoButton(padding: const EdgeInsets.symmetric(vertical: 8),
                    onPressed: _forgot,
