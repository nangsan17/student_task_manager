...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _register() async {
    ...
    try {
      ...
      if (!mounted) return;
      setState(() { _loading = false; _error = _friendly(e.toString()); });
    }
  }
    ...
    return Scaffold(
      ...
      body: SafeArea(child: SingleChildScrollView(
        ...
        child: Form(key: _formKey, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('Join SPTM', style: Theme.of(context).textTheme.headlineMedium).animate().fadeIn(),
          const SizedBox(height: 4),
          Text('Start managing your tasks today', style: Theme.of(context).textTheme.bodyMedium).animate().fadeIn(delay: 80.ms),
          ...
          TextFormField(controller: _passCtrl, obscureText: _obscureP, textInputAction: TextInputAction.next,
          ...
          TextFormField(controller: _confirmCtrl, obscureText: _obscureC, textInputAction: TextInputAction.done,
            ...
            validator: (v) => (v == null || v.isEmpty) ? 'Please confirm password'
